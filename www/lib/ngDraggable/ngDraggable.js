                ...
                link: function (scope, element, attrs) {
                    ...
                    var updateDragStyles = function(touching, dragElement) {
                        if(touching){
                            ...
                            if(element.hasClass('spaceDropIgnore')){
                              dragElement.addClass('drag-over2');
                            }
                            else{
                              dragElement.addClass('drag-over3');
                            }
                        }else if(_lastDropTouch == element){
                            _lastDropTouch=null;
                            element.removeClass('drag-enter');
                            dragElement.removeClass('drag-over');
                            dragElement.removeClass('drag-over2');
                            dragElement.removeClass('drag-over3');
